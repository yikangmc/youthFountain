...
//    		ResponseMessage data=SendRequest.sendPostRetureResponseMessage("00-28-02", paramData,res.getClass());
//    		res.setData((List<FormPosts>)data.getData());
    	}catch(Exception e){
...
//    			 ResponseMessage data=SendRequest.sendPostRetureResponseMessage("00-28-02", paramData,res.getClass());
//
//    			 res.setData((FormPosts)data.getData());
    		 }else{
    			 res.setStatus(ExceptionConstants.parameterException.parameterException.errorCode);
         		 res.setMessage(ExceptionConstants.parameterException.parameterException.errorMessage);
    		 }
