...
public class Activety {
    ...
    private List<ActivetyComment> activetyComments;
	...
	public List<ActivetyComment> getActivetyComments() {
		return activetyComments;
	}

	public void setActivetyComments(List<ActivetyComment> activetyComments) {
		this.activetyComments = activetyComments;
	}
}